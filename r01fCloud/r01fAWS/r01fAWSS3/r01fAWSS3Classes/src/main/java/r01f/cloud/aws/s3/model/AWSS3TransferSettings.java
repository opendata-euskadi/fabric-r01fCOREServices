...
import static r01f.util.types.BinaryUnitsUtils.GB;
import static r01f.util.types.BinaryUnitsUtils.KB;
import static r01f.util.types.BinaryUnitsUtils.MB;
...
@NoArgsConstructor
@Accessors(prefix="_")
public class AWSS3TransferSettings
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
	public static String asHumanReadableSize(final long size) {
 	...
 	private static String _floatForm(final double d)   {
